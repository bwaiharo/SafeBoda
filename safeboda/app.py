...
# The database URI
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL','') or "sqlite:///SafeBoda.sqlite"

db = SQLAlchemy(app)


# Create our database model
class SafeBoda(db.Model):
    __tablename__ = 'SafeBoda_Passenger_Cancellations_Kampala_Jan11_17'

    trip_id = db.Column(db.Integer, primary_key=True)
    trip_date = db.Column(db.Text)
    passenger_id = db.Column(db.Integer)
    driver_id = db.Column(db.Integer)
    parish = db.Column(db.String(27))
    subcounty = db.Column(db.String(13))
    ping_requested  = db.Column(db.String(15))
    pair_requested =   db.Column(db.String(15))
    passenger_cancelled = db.Column(db.String(15))
    passenger_cancelled = db.Column(db.String(15))
    driver_arrived = db.Column(db.String(15))
    started_trip = db.Column(db.String(15))
    ended_trip = db.Column(db.String(15))
    current_state = db.Column(db.String(18))
    driver_distance_at_acceptance = db.Column(db.Integer)
